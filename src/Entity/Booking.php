...
class Booking
{
     ...
     * @Assert\GreaterThan("today", message="La date d'arrivée doit être ultérieure à la date d'aujourd'hui !", groups={"frontEnd"})
     */
    private $startDate;
    ...
    /**
     * Callback appellé a chaque fois qu'on crée une réservation
     * 
     * @ORM\Prepersist
     * @ORM\PreUpdate
     *
    ...
    public function isBookableDates(){
        ...
        // Tableau des chaines de caractères de mes journées réservées
